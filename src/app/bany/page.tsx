  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        {/* Filters */}
        <div className="bg-white rounded-xl p-4 sm:p-6 mb-10 shadow-sm">
          <div className="flex flex-wrap gap-4 sm:gap-6">
            <div className="w-full sm:w-auto">
              <div className="font-bold text-[#2D4A32] mb-3">Размер</div>
              <div className="flex flex-wrap gap-2">
                <button className="px-3 sm:px-4 py-2 bg-[#2D4A32] text-white rounded-full text-sm">Все</button>
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">3×4</button>
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">5×3</button>
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">5×4</button>
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">6×6</button>
              </div>
            </div>
            <div className="w-full sm:w-auto">
              ...
              <div className="flex flex-wrap gap-2">
                <button className="px-3 sm:px-4 py-2 bg-[#2D4A32] text-white rounded-full text-sm">Все</button>
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">Русский угол</button>
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">Чистый угол</button>
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">Канадская чаша</button>
              </div>
            </div>
            <div className="w-full sm:w-auto">
              <div className="font-bold text-[#2D4A32] mb-3">Опции</div>
              <div className="flex flex-wrap gap-2">
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">С мансардой</button>
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">С террасой</button>
                <button className="px-3 sm:px-4 py-2 border border-gray-300 rounded-full text-sm hover:border-[#2D4A32]">Под рубанок</button>
              </div>
            </div>
          </div>
        </div>
