...
export const metadata = {
  ...
  description:
    "Каталог беседок ручной рубки из сосны. Открытые и закрытые. Открытый прайс. Доставка по Беларуси.",
};

export default async function BesedkiPage() {
  const besedki = await getProducts("besedka");
